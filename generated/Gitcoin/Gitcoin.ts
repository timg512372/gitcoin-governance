...
export class Gitcoin__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Gitcoin extends ethereum.SmartContract {
  static bind(address: Address): Gitcoin {
    return new Gitcoin("Gitcoin", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Gitcoin__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Gitcoin__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Gitcoin__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Gitcoin__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
